					...
					<tr> 
						<td style="width: 100%;"></td>
				        	<td style="width: 150px;">
				      			<base-button class="btn btn-primary" @click="updateShippingDetail()">Save</base-button>
				        	</td>
				        	<td style="width: 150px;">
				        	<td style="width: 150px;">
								...
								<div >
								  <div class="container">
												    <base-button class="btn btn-primary" @click="modal2ShippingDetails = true">Add</base-button>
								              <modal :show.sync="modal2ShippingDetails">
          ...
          <a-modal :footer="null" :visible="userPermissionDialog" :closable="false" class="centered-modal" v-if="userPermissionDialog">
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
										...
										<tr> 
					<td class="detail_view_column_2">Shipping Detail Id</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="ShippingDetailId" type="text" placeholder="Enter ShippingDetailId" v-model="shippingDetailDetails.shippingDetailId"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Address</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Address" type="text" placeholder="Enter Address" v-model="shippingDetailDetails.address"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">City</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="City" type="text" placeholder="Enter City" v-model="shippingDetailDetails.city"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Postal Code</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="PostalCode" type="text" placeholder="Enter PostalCode" v-model="shippingDetailDetails.postalCode"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Country</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Country" type="text" placeholder="Enter Country" v-model="shippingDetailDetails.country"></input>
																		</div>
						</td>
														</tr>
...
export default {
  ...
  data() {
    return {
      shippingDetailToAdd: {},
      modal2ShippingDetails: false,
      shippingDetailDetails: null,
  ...
  methods: {
    ...
    async handleAddSubmitted() {
      this.modal2ShippingDetails = false;
    ...
    async updateShippingDetail() {
      ...
      const jsonData = JSON.stringify(this.shippingDetailDetails);
      const res = await ShippingDetailService.update(jsonData);
...
//        this.getAllShippingDetails();
    ...
    async getShippingDetailDetails() {
      try {
			let response = await ShippingDetailService.get(this.shippingDetailId);
			this.shippingDetailDetails = response.data;
